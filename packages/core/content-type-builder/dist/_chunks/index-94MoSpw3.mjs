...
const ListView$1 = lazy(() => import("./ListView-KPsV_3s_.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-KPsV_3s_.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-94MoSpw3.mjs.map
