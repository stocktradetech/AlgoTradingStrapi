...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-kIIXqMj8.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-o06XWpIO.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-u6acgqTS.mjs.map
