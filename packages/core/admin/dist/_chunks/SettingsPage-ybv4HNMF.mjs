...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-kIIXqMj8.mjs";
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-4iPfim4R.mjs")).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-uVPiyAW5.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-1rouV_z0.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-lEbZ452X.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-HUm4UB9V.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-5KhKfTwr.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-1HFdUk8G.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-u6acgqTS.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-I-O7nwck.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-m7avzONt.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-vhnZpXy-.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-mU4u4hR7.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-jwTfyUEY.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-pegwib8t.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-95ar4DYn.mjs");
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-pvVvaLhV.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-drOBVshk.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-ybv4HNMF.mjs.map
